      ...
      <ChatUi
        video={
          <div className="relative h-screen flex-1 basis-1/2  rounded-2xl  lg:mx-4 lg:my-4   ">
            ...
            <div className="absolute bottom-20 left-0 right-0 m-auto flex h-20 w-auto flex-row items-center justify-around lg:bottom-[10rem] md:bottom-[4rem]  ">
        ...
        chat={
          <div className="hidden  h-screen  w-screen flex-1 basis-1/5 flex-col sm:m-4 sm:mx-1 md:my-4  lg:block lg:pr-4 2xl:block">
            <div className=" lg:h-3/4 w-full flex-col justify-center rounded-2xl bg-white drop-shadow-xl max-h-fit ">
